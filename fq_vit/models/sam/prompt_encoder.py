...
from fq_vit.models.ptq.layers import QAct, QConv2d
...
class PromptEncoder(nn.Module):
    def __init__(
        ...
        self.mask_downscaling = nn.ModuleList(
            [
                QConv2d(
                    1,
                    mask_in_chans // 4,
                ...
                QIntLayerNorm2D(mask_in_chans // 4),
                activation(),
                QConv2d(
                    mask_in_chans // 4,
                    mask_in_chans,
    ...
    def _embed_masks(self, masks: torch.Tensor) -> torch.Tensor:
        """Embeds mask inputs."""
        x = masks
        for i, mod in enumerate(self.mask_downscaling):
