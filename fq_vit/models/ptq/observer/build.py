...
def build_observer(observer_str, module_type, bit_type, calibration_mode, permute=True):
    observer = str2observer[observer_str]
    return observer(module_type, bit_type, calibration_mode, permute=permute)
